{
  ...
  val USE_TOKEN_ID = fromBase64("")               // todo a55b…2669
  val VAULT_NFT = fromBase64("")                  // todo vault singleton NFT
  val DOUBLE_REDEEM_NFT = fromBase64("")          // todo DoubleRedeem NFT
  val UNLOCK_INTENT_SCRIPT_HASH = fromBase64("")  // todo blake2b256(UnlockIntent propBytes)
  val RECEIPT_SCRIPT_HASH = fromBase64("")        // todo blake2b256(DepositReceipt propBytes)
  val FEE_POT_SCRIPT_HASH = fromBase64("")        // todo blake2b256(FeePot propBytes)
