# Aegis — adversarial catalog (appendix)

**Date:** 2026-07-11  
**Status:** living appendix to [security.md](./security.md) (not primary reading)  
**Role:** attack-by-attack tables. Mitigations summary: `security.md`.  
**Verdict up front:** **Ship dogfood / testnet** under **U1-dogfood**. **Serious TVL** needs **U1-strong**.

Severity: **C**ritical / **H**igh / **M**edium / **L**ow · Status updated after design mitigations.

---

## Mitigation map (design stage — see `notes/archive/design-mitigations.md`; legend in [security.md](./security.md) §5)
...
### B4. Fee bypass / public fee leaks amount — **M** · mitigated by design (2026-07-12)

**Attack:** Skip fee; or public fee = f(amount) turning fees into an amount oracle.  
**Mitigate:** Consensus-enforced flat amount-independent SC fee + uniform tx shape; value-scaling only at public peg edges (params.md standing rule).
...
### E4. Fee pot / emission-box accounting drift — **M** · open

**Attack:** SC pot credited without a matching proven fee event (or double-credited on Ergo reorg) ⇒ pot over-mint ⇒ coinbase pays unbacked USE; or fee boxes never merged ⇒ invariant lie.  
**Mitigate:** Pot credits 1:1 with proven fee events (same proof object as PegMint / PegBurn); I1 includes the pot term; consolidator monitors unmerged fee boxes.
