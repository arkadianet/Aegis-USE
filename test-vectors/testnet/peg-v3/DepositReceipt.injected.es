{
  ...
  val USE_TOKEN_ID = fromBase64("AfToX1IUvSmq4n3J4L/tKpNNV4P77gQiSjDIN5WD2ig=")   // todo inject a55b…2669
  val PEG_VAULT_NFT = fromBase64("AffC+1jABTpX+QUfGkBRS9D/OKLeEkMmasXXJz8+8Ww=")  // todo inject vault singleton NFT id
