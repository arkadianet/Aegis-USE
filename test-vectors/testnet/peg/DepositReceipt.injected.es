{
  ...
  val USE_TOKEN_ID = fromBase64("AGozr5spXIMLH+GUIu3gA9o1ocOl9qxWYY6Z7y6qK6s=")   // todo inject a55b…2669
  val PEG_VAULT_NFT = fromBase64("AGrSH9SLxmdtqw57Mt+AsNKRGZEr+ekCL2Du2EQGcwc=")  // todo inject vault singleton NFT id
